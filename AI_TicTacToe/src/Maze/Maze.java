...
/**
 * Class Maze - class for representing search space as a bi-dimensional maze The
 * class Maze is used to record the data for a bi- dimensional maze (with
 * obstacles as well as their starting and ending locations indicated by  *
 * three static short integer values).
 *
 */
public class Maze {
